...
constexpr auto p_mut = 0.05;        // mutation rate
...
// random number generator of double according to the exponential distribution with rate of occurrence 1
// used to compute the number of mutation that should be introduced if an individual is allowed to mutate
exponential_distribution<double> expgen(1.f);
...
// fittest individual so far
	individual* solution = candidates.fittest;
	int the_iter = 0;
